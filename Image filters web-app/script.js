...
document.querySelectorAll('button')[0].addEventListener("click" , Changeinvert);
document.querySelectorAll('button')[1].addEventListener("click" , Changelining);
document.querySelectorAll('button')[2].addEventListener("click" , Changesepia);
document.querySelectorAll('button')[3].addEventListener("click" , Changereflect);
document.querySelectorAll('button')[4].addEventListener("click" , Changeblur);
document.querySelectorAll('button')[5].addEventListener("click" , Changegreyscale);
document.querySelectorAll('button')[6].addEventListener("click" , Changebreaking);
document.querySelectorAll('button')[7].addEventListener("click" , Changeclear);
